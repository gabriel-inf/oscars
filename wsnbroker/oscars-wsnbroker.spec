%define package_name wsnbroker 
%define service_name WSNBrokerService
...
Version:        0.6
Release:        %{relnum}
Summary:        OSCARS WS-Notification Broker 
...
%description
The OSCARS WS-NotificationBroker handles the distribution of notifications according to the WS-Notification specification.
