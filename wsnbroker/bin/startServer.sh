...
echo "Starting WS-NotificationBroker service with context set to $context"
java -Xmx500m -Djava.net.preferIPv4Stack=true -jar target/wsnbroker-0.0.1-SNAPSHOT.one-jar.jar -c $context  &
