...
public class ConfigGenTest {
    ...
    public void testL3Setup() throws BSSException, PSSException {
        ...
        out = th.generateL3Setup(resv, resv.getPath(PathType.LOCAL), PSSDirection.Z_TO_A);
        System.out.println(out);
    }
    @Test
    public void testL2Teardown() throws BSSException, PSSException {
        ...
        // System.out.println(out);
        out = th.generateL3Teardown(resv, resv.getPath(PathType.LOCAL), PSSDirection.Z_TO_A);
        // System.out.println(out);
    }
    @Test
