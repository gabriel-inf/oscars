%define package_name bandwidthPCE 
%define service_name BandwidthPCE
%define pce_name bandwidth
...
%description
An OSCARS PCE that prunes oversubscribed links in terms of bandwidth.
