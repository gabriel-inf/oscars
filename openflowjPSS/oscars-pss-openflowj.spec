%define package_name openflowjPSS 
%define service_name PSSService
%define pss_name openflowj
...
%description
An OSCARS PSS that implement an OpenFlow controller. This PSS is capable of sending
OpenFlow messages directly to OpenFlow-enabled devices.
