...
public class NsiCommands implements CommandMarker {
    ...
    public String nsi_help() {
        ...
        help += "Prerequisites:\n";
        help += "==============\n";
        help += "0. Default settings will be loaded at start,\n";
        help += "   unless they are not available,\n";
        help += "   Use the 'defaults' commands to set defaults.\n";
        help += "To override defaults:,\n";
        help += " - Use the prov commands to change provider settings,\n";
        help += " - Use the req commands to change requester settings.\n";
        help += " - Use the resv commands to load reservation profiles,\n";
