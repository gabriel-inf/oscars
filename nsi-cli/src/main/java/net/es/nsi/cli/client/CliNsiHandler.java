...
public class CliNsiHandler implements ConnectionRequesterPort {
    ...
    public void errorEvent(
        ...
        System.out.println("\nReceived errorEvent for connectionId: "+connectionId+"\n");
    }
    @Override
    public void messageDeliveryTimeout(@WebParam(name = "connectionId", targetNamespace = "") String connectionId,
                                       @WebParam(name = "notificationId", targetNamespace = "") int notificationId,
                                       @WebParam(name = "timeStamp", targetNamespace = "") XMLGregorianCalendar timeStamp,
                                       @WebParam(name = "correlationId", targetNamespace = "") String correlationId,
                                       @WebParam(name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/07/framework/headers", header = true) CommonHeaderType header,
                                       @WebParam(mode = WebParam.Mode.OUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/07/framework/headers", header = true) Holder<CommonHeaderType> header1) throws ServiceException {
        System.out.println("\nReceived messageDeliveryTimeout for connectionId: "+connectionId+"\n");
    }

    @Override
    public void reserveConfirmed(@WebParam(name = "connectionId", targetNamespace = "") String connectionId,
    ...
    @Override
    public void dataPlaneStateChange(@WebParam(name = "connectionId", targetNamespace = "") String connectionId,
                                     @WebParam(name = "notificationId", targetNamespace = "") int notificationId,
                                     @WebParam(name = "timeStamp", targetNamespace = "") XMLGregorianCalendar timeStamp,
