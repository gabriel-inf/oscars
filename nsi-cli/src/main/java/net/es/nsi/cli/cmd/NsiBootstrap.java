...
public class NsiBootstrap {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            bootstrap = new NsiBootstrap(args);
    ...
    public NsiBootstrap(String[] args) throws IOException {
        this(args, CONTEXT_PATH);
    }

    public NsiBootstrap(String[] args, String[] contextPath) {
        try {
    ...
    private void configureApplicationContext(GenericApplicationContext annctx) {
        ...
        /*
        createAndRegisterBeanDefinition(annctx, DefaultsCommands.class);
        createAndRegisterBeanDefinition(annctx, ProviderCommands.class);
        createAndRegisterBeanDefinition(annctx, RequesterCommands.class);
        createAndRegisterBeanDefinition(annctx, ResvCommands.class);
        createAndRegisterBeanDefinition(annctx, NsiCommands.class);
        */

        createAndRegisterBeanDefinition(annctx, DefaultsConverter.class);
        createAndRegisterBeanDefinition(annctx, ProviderProfileConverter.class);
        createAndRegisterBeanDefinition(annctx, RequesterProfileConverter.class);
        createAndRegisterBeanDefinition(annctx, ResvProfileConverter.class);
        createAndRegisterBeanDefinition(annctx, NattyDateConverter.class);

        createAndRegisterBeanDefinition(annctx, org.springframework.shell.core.JLineShellComponent.class, "shell");

        createAndRegisterBeanDefinition(annctx, org.springframework.shell.commands.HelpCommands.class);
        createAndRegisterBeanDefinition(annctx, org.springframework.shell.commands.ExitCommands.class);
        createAndRegisterBeanDefinition(annctx, org.springframework.shell.commands.ScriptCommands.class);
        createAndRegisterBeanDefinition(annctx, org.springframework.shell.commands.InlineCommentCommands.class);
        // createAndRegisterBeanDefinition(annctx, org.springframework.shell.commands.ConsoleCommands.class);
