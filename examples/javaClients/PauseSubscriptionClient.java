...
public class PauseSubscriptionClient extends Client{
    private String url;
    private String repo;
    
    public PauseSubscription readArgs(String[] args) throws AxisFault{
        PauseSubscription pause = new PauseSubscription();
        ...
        pause.setSubscriptionReference(subRef);
    ...
    public void printHelp(){
		 ...
		 System.out.println("\t-id\t required. the id of the subscription to pause. (i.e. urn:uuid:14c88353-df91-44f7-9193-88fce3ae7ba2");
	}
    ...
    public static void main(String[] args){
        PauseSubscriptionClient client = new PauseSubscriptionClient();
        try{
            PauseSubscription request = client.readArgs(args);
            PauseSubscriptionResponse unsubResponse = client.pauseSubscription(request);
            ...
            System.out.println("Subscription paused.");
        }catch(Exception e){
            e.printStackTrace();
        }
    }
