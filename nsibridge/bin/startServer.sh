...
java -Djava.net.preferIPv4Stack=true -Xmx512m -Dnsibridge.manifest=file:/etc/oscars/NsiBridgeService/conf/manifest.yaml -Dnsibridge.beans=file:/etc/oscars/NsiBridgeService/conf/beans.xml -jar $jarfile&
echo $! > $pidfile
