...
public class ConnectionServiceProvider extends Service {
    ...
    public final static QName SERVICE = new QName("http://schemas.ogf.org/nsi/2011/07/connection/provider", "ConnectionServiceProvider");
    public final static QName ConnectionServiceProviderPort = new QName("http://schemas.ogf.org/nsi/2011/07/connection/provider", "ConnectionServiceProviderPort");
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/haniotak/helios/fenius/nsibridge/schema/ogf_nsi_connection_provider_v1_0.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ConnectionServiceProvider.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/haniotak/helios/fenius/nsibridge/schema/ogf_nsi_connection_provider_v1_0.wsdl");
        }
        WSDL_LOCATION = url;
    }
