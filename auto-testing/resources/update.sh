...
#mkdir -p $HOME/OSCARSService
#cp -f $OSCARS_HOME/OSCARSService/conf/config.HTTP.yaml $HOME/OSCARSService
#cp -f $OSCARS_HOME/OSCARSService/conf/config.SSL.yaml $HOME/OSCARSService
...
#cp -f $HOME/OSCARSService/* $OSCARS_HOME/OSCARSService/conf
...
echo "Please run '$OSCARS_DIST/tools/bin/idc-wbuiaccess'"
