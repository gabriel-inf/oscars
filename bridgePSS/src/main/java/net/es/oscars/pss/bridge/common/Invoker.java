package net.es.oscars.pss.bridge.common;
...
import net.es.oscars.pss.bridge.soap.BridgePSSSoapServer;
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (mode.equals("server")) {
            ...
            try {
                ...
                BridgePSSSoapServer server = BridgePSSSoapServer.getInstance();
