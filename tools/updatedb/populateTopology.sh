...
mv -f ${CATALINA_HOME}/logs/populateTopology.log ${CATALINA_HOME}/logs/populateTopology.log.bak > /dev/null 2>&1
# start up logging to file
javac `pwd`/PopulateDB.java
java -Djava.net.preferIPv4Stack=true PopulateDB $* > ${CATALINA_HOME}/logs/populateTopology.log 2>&1
