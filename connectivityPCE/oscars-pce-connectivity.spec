...
Version:        0.6
Release:        %{relnum}
Summary:        OSCARS Connectivity PCE
...
%description
An OSCARS PCE that builds the initial graph of domains by doing breadth-first search from the destinaion to source domain. 
