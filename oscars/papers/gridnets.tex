...
traffic; 
coordinating quality service end-to-end 
...
The closest coordination is with the Internet2 BRUW \cite{bruw} system. 
...
Web services standards are used wherever possible.  SOAP \cite{SOAP} messsages are
...
systems
that are co-operating with OSCARS.  If a match is found, the request is 
...
GEANT's \cite{geant-amps} Advance Multi-domain Provisioning
System (AMPS) [AMPS]. This interface is being tested with the 
...
interdomain authorization depends on SLA's between domains and the
assurance that  a request is coming from a trusted server in a trusted domain. Normally all requests between domains will be a SOAP "forward"  message
...
related to this work (e.g.: \cite{geant}, \cite{ndl}, \cite{canarie-interop}, \cite{ietf-ccamp}). However due to the
...
layers, no such comparable protocols exists.
...
\bibitem{AMPS}
http://www.geant2.net/server/show/conWebDoc.998 (URL valid Jun 5, 2006)

\bibitem{ballinger}
K. Ballinger, D. Ehnebusk, M. Gudgin, M. Nottingham, P. Yendluri, \emph{Basic Profile, Version 1.0}, WS-I Reccommendation, April, 2004, http://www.ws-i.org/Profiles/BasicProfile-1.0-2004-04-16.html (URL valid 5/06/2006)

\bibitem{bell}
E.Bell, A.Smith, P.Langille, A.Rijhsinghani, K.McLoghrie,D\emph{"Definitions of Managed Objects for Bridges
...
\bibitem{burruss}
J.R.Burruss, T.W.Fredian, M.R.Thompson. \emph{Security on the U.S. FusionGridD}, Fusion Engineering and Design, Elesevier, to appear in 2006

\bibitem{rsvp-te}
L. Berger (ed), ÒGeneralized MPLS Signaling - RSVP-TE Extensions,Ó IETF RFC 3473, January 2003.
...
\bibitem{cops-pr}
K. Chan et al., ÒCOPS Usage for Policy Provisioning 
(COPS-PR),Ó IETF RFC 3084, March 2001.

  \bibitem{WSDL}
 E. Christensen,  F. Curbera, G. Meredith, S. Weerawarana, \emph{Web Services Description Language (WSDL) 1.1} W3C Reccommendation, March, 2001, http://www.w3.org/TR/wsdl (URL valid 5/06/2006) 
...
\bibitem{cops}
D. Durham et al., ÒThe COPS (Common Open Policy 
Service Protocol),Ó IETF RFC 2748, January 2000. 
...
%http://www.geant2.net/ (URL valid 5/06/2006)
...
\bibitem{SOAP}
N.Mitra (ed.) \emph{SOAP Version 1.2 Part 0: Primer}, W3C Recommendation 24-June-2003.  http://www.w3.org/TR/soap12-part0/ (URL valid 5/0/2006)
...
\bibitem{shallow}
G. Swallow, et al., \emph{Generalize Multiprotocol Label Switching(GMPLS) User-Network Interface (UNI):
