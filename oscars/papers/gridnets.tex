...
It also supports an API using the SOAP messaging protocol to support programmable 
...
the \emph{Web Services Definition Language} (\textbf{WSDL}) is used for the service description.
...
eXtensible Access Control Markup Language (XACML) Version 2
