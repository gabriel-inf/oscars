...
utilizing the OSCARS service is classified into a Class-of-Service (CoS) distinct 
...
With all of OSCARS traffic using the same CoS queue within the 
...
originator of the message.  The W3C \textbf{XML-Signature} rules and syntax are used 
for the signing.
