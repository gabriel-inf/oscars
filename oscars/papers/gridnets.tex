...
TeraPaths \cite{terapaths} and USN [USN] projects, the NSF funded CHEETAH \cite{veeraraghavan} and
DRAGON \cite{yang}\cite{dragon} projects,
Internet2's BRUW \cite{bruw} and HOPI [HOPI] projects, CANARIE's UCLP \cite{canarie} 
project, and GEANT's
...
related to this work [Ref JRA3, \cite{ndl} \cite{},UCLP,IETF CCAMP]. However due to the
