...
TeraPaths \cite{bradley} and UltraScience Net \cite{usn} projects, the NSF funded CHEETAH \cite{veeraraghavan} and
...
P.~Yendluri, ``Basic Profile Version 1.0,'' Apr. 2004, Available at: \\
...
in \emph{Fusion Engineering and Design}, Elesevier, to appear Fall 2006.
...
in \emph{Computing in High Energy and Nuclear Physics (CHEP 2006)}, T.I.F.R.,
Mumbai, India, Feb. 13-17, 2006.

\bibitem{canarie}
``Canarie UCLP Project,'' Available at: \\
\url{http://www.canarie.ca/canet4/uclp/}

\bibitem{canarie-interop}
``Canarie Interoperability Work,'' Available at: \\
...
``Web Services Description Language (WSDL) 1.1,'' Mar. 2001,
...
submitted to
\emph{2006 International Symposium on Collaborative Technologies and Systems (CTS 2006)}.
...
``XML-Signature Syntax and Processing,'' Feb. 2002, Available at: \\
\url{http://www.w3.org/TR/2002/REC-xmldsig-core-20020212/}

\bibitem{esnet-pc}
``ESnet Performance Center,'' Available at: \\
\url{https://performance.es.net/}

\bibitem{hopi}
``Internet2 HOPI Project,'' Available at: \\
\url{http://networks.internet2.edu/hopi/}

\bibitem{geant}
``GEANT GN2-JRA3 Project,'' Available at: \\
\url{http://www.geant2.net/server/show/nav.756}

\bibitem{geant-amps}
``GEANT AMPS Project,'' Available at: \\
...
\emph{Proceedings of IEEE GRIDNETS 2005}.
...
vol. 44, no. 3, Mar. 2006.

\bibitem{SOAP}
N.~Mitra,~Ed.,
``SOAP Version 1.2 Part 0: Primer,'' Jun. 2003, Available at:
\url{http://www.w3.org/TR/soap12-part0/}

\bibitem{ndl}
J.~van~der~Ham, F.~Dijkstra, F.~Travostino, H.~Andree, and C.~de~Laat,
\emph{Using RDF to Describe Networks},
Unpublished
(accepted by Future Generation Computer Systems, Feature topic iGrid 2005),
October 2005.
...
\bibitem{ietf-ccamp}
``IETF CCAMP Working Group,'' Available at:
...
\bibitem{usn}
``DOE UltraScience Network Project,'' Available at: \\
\url{http://www.csm.ornl.gov/ultranet/};
