...
architecture of OSCARS, and Section III describes issues involved in
...
path are coordinated by the reservation manager and managed by the routers in 
the network.

\subsection{Components}

The reservation manager (RM) handles all capabilities except for initial
router configuration.  The RM is comprised of three components:  the 
