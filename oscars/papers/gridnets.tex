...
\subsection{Dragon, OCLP, TeraPaths, etc.}
brian
\subsection{how OSCARS is differnt}
david
...
\subsection{use of web services (David)}
\subsection{AAA (Mary)}

\section{Interdomain Reservations}
\subsection{multiple domains (Jason and David)}
\subsection{reverse paths (Jason)}
\subsection{interoperability (preformance??) and collaborations:  (Jason/David/Chin)}
I2
...
\subsection{Standards (Brian)}
\subsection{Testing and TestBeds (Brian and Chin)}
