...
interface has been specified following the model of GEANT's \cite{geant-amps}
...
To facilitate interdomain virtual circuit setup, a WSDL was created to describe
