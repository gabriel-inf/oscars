...
originating from a different AS then it originally sent the \emph{Create} request
out to.
...
In April 2006, an inter-domain guaranteed bandwidth path between Abilene and 
