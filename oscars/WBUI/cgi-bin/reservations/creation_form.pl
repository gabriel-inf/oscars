...
sub print_reservation_form {
    ...
    <form method="post" action=""
      ...
      <table>
        ...
        <tr>
          <td class="required">
            <input type="text" name="source_host" size="29"></input>
          </td>
          <td class="required">
            <input type="text" name="destination_host" size="29"></input>
          </td>
          <td class="required">
      ...
      <p>
      Indicate the starting date and time, and the duration in hours, of your 
      reservation.  Fields left blank will default to the examples below the 
      input fields.  The default time zone is the local time.
    };
    ...
    <p>
    The following are optional fields.  <strong>DSCP</strong> sets the 
    ...
    <table cols="4">
      ...
      <tr>
        <td>
          <input type="text" name="reservation_src_port" maxlength="5" 
                 size="17">
          </input>
        </td>
        <td>
          <input type="text" name="reservation_dst_port" maxlength="5"
                  size="17">
          </input>
        </td>
        <td>
          <input type="text" name="reservation_protocol" size="17"></input>
        </td>
        <td>
          <input type="text" name="reservation_dscp" maxlength="2" size="17">
          </input>
        </td>
      </tr>
      <tr>
