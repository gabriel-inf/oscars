...
function check_form( form )
{
    ...
    */
    ...
    if ( (form.origin.value == null) || (form.origin.value == "") ||
          isblank(form.origin.value) )
    {
        alert( "Please enter starting host name, or its IP address ." );
        form.origin.focus();
        return false;
    }
    if ( (form.destination.value == null) || (form.destination.value == "") ||
          isblank(form.destination.value) )
    {
        alert( "Please enter destination host name, or its IP address." );
        form.destination.focus();
        return false;
    }
    if ( (form.reservation_bandwidth.value == null) || 
         (form.reservation_bandwidth.value == "") || 
         isblank(form.reservation_bandwidth.value) )
    {
    ...
    if ( (form.start_year.value == null) || (form.start_year.value == "") ||
         isblank(form.start_year.value) )
    {
        form.start_year.value = currentDate.getFullYear();
    }
    if ( (form.start_month.value == null) || (form.start_month.value == "") ||
         isblank(form.start_month.value) )
    {
        form.start_month.value = currentDate.getMonth() + 1;
    }
    if ( (form.start_date.value == null) || (form.start_date.value == "") ||
         isblank(form.start_date.value) )
    {
        form.start_date.value = currentDate.getDate();
    }

    if ( (form.start_hour.value == null) || (form.start_hour.value == "") || 
         isblank(form.start_hour.value) )
    {
        form.start_hour.value = currentDate.getHours();
    }

    if ( (form.start_minute.value == null) || 
         (form.start_minute.value == "") || isblank(form.start_minute.value) )
    {
        form.start_minute.value = currentDate.getMinutes();
    }

    if ( (form.duration_hour.value == null) || 
         (form.duration_hour.value == "") || 
         isblank(form.duration_hour.value) )
    {
    ...
    if ( (form.reservation_description.value == null) || 
         (form.reservation_description.value == "") || 
         isblank(form.reservation_description.value) )
    {
