#==============================================================================
package OSCARS::AAA::Method::Authorization::Remove;

=head1 NAME

OSCARS::AAA::Method::Authorization::Remove - Remove an authorization

=head1 SYNOPSIS

  use OSCARS::AAA::Method::Authorization::Remove;

=head1 DESCRIPTION

This is an AAA SOAP method.  It manages the deletion of a row from the
