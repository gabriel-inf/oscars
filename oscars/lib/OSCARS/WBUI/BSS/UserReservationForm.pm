#==============================================================================
package OSCARS::WBUI::BSS::UserReservationForm;

=head1 NAME

OSCARS::WBUI::BSS::UserReservationForm - outputs reservation request form

=head1 SYNOPSIS

  use OSCARS::WBUI::BSS::UserReservationForm;

=head1 DESCRIPTION

Handles user's request to display the create reservation form.
...
sub output {
    ...
    <form method='post' action=''
      ...
      <table>
        <tr><th>Source</th><th>Destination</th><th>Bandwidth (Mbps)</th></tr>
        <tr>
          <td class='required'>
      ...
      <tr><th>Year</th><th>Month</th><th>Date</th><th>Hour</th><th>Minute</th>
          <th>UTC offset</th><th>Duration (Hours)</th>
      </tr>
      <tr>
        <td>
