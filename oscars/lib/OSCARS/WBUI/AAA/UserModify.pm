#==============================================================================
package OSCARS::WBUI::AAA::UserModify;

=head1 NAME

OSCARS::WBUI::AAA::UserModify - Gets the profile for the given OSCARS user.

=head1 SYNOPSIS

  use OSCARS::WBUI::AAA::UserModify;
...
sub outputDiv {
    ...
    my $modifySubmitStr = "return submit_form(this,
                    'component=AAA;method=UserModify;',
