#==============================================================================
package OSCARS::WBUI::AAA::ResourceList;

=head1 NAME

OSCARS::WBUI::AAA::ResourceList - List all resources and permissions.

=head1 SYNOPSIS

  use OSCARS::WBUI::AAA::ResourceList;
...
sub resourceEntryFields {
    ...
    my $addSubmitStr = "return submit_form(this,
                    'component=AAA;method=ResourcedAdd;');";
    my $deleteSubmitStr = "return submit_form(this,
                    'component=AAA;method=ResourceRemove;');";
    print( qq{
    <td class='auth-ui-td'>
    <table>
    <tbody>
...
sub permissionEntryFields {
    ...
    my $addSubmitStr = "return submit_form(this,
                    'component=AAA;method=PermissionAdd;');";
    my $deleteSubmitStr = "return submit_form(this,
                    'component=AAA;method=PermissionRemove;";
    print( qq{
    <td class='auth-ui-td'>
    <table>
    <tbody>
