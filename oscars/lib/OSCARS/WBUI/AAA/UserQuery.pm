#==============================================================================
package OSCARS::WBUI::AAA::UserQuery;

=head1 NAME

OSCARS::WBUI::AAA::UserQuery - Gets the profile for the given OSCARS user.

=head1 SYNOPSIS

  use OSCARS::WBUI::AAA::UserQuery;
...
sub outputDiv {
    ...
    my $modifySubmitStr = "return submit_form(this,
            'component=AAA;method=UserModify;', check_profile_modification);";
    my $msg = "User profile";
    print( qq{
    <div>
