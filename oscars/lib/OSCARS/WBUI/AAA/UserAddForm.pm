#==============================================================================
package OSCARS::WBUI::AAA::UserAddForm;

=head1 NAME

OSCARS::WBUI::AAA::UserAddForm - Outputs HTML form for adding a user.

=head1 SYNOPSIS

  use OSCARS::WBUI::AAA::UserAddForm;
...
sub outputDiv {
    ...
    my $submitStr = "return submit_form(this, 'component=AAA;method=UserAdd;',
			                check_add_user);";
