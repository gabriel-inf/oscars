%define package_name vlanPCE 
%define service_name VlanPCE
%define pce_name vlan
...
%description
An OSCARS PCE that prunes oversubscribed links in terms of VLANs.
