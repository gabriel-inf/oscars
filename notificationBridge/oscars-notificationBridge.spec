%define package_name notificationBridge 
%define service_name NotificationBridgeService
...
%description
The OSCARS notification bridge handles sending notifications from the coordinator to external notification services. It also provides a means to send email notifications.
