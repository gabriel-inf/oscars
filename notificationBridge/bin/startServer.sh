...
echo "Starting NotificationBridge with context set to $context"
java -Djava.net.preferIPv4Stack=true -jar target/notificationBridge-0.0.1-SNAPSHOT.one-jar.jar -c $context  &
