...
%description
The OSCARS Coordinator service manages the OSCARS workflow.
...
%{package_name}/scripts/configure_keystores %{buildroot}/%{oscars_home}/PCEService/conf %{oscars_home}/keystores/oscars.jks %{oscars_home}/keystores/localhost.jks  %{oscars_home}/keystores/oscars.jks "pce-runtime-"
