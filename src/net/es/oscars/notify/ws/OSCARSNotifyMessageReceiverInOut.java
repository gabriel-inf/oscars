        ...
        */
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJava(op.getName().getLocalPart())) != null)){
            ...
            if("ResumeSubscription".equals(methodName)){
                ...
                org.oasis_open.docs.wsn.b_2.ResumeSubscriptionResponse resumeSubscriptionResponse34 = null;
	                        org.oasis_open.docs.wsn.b_2.ResumeSubscription wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               resumeSubscriptionResponse34 =
                                                   
                                                   
                                                         skel.ResumeSubscription(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), resumeSubscriptionResponse34, false);
                                    } else 

            if("RegisterPublisher".equals(methodName)){
                
                org.oasis_open.docs.wsn.br_2.RegisterPublisherResponse registerPublisherResponse36 = null;
	                        org.oasis_open.docs.wsn.br_2.RegisterPublisher wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               registerPublisherResponse36 =
                                                   
                                                   
                                                         skel.RegisterPublisher(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), registerPublisherResponse36, false);
                                    } else 

            if("Unsubscribe".equals(methodName)){
                
                org.oasis_open.docs.wsn.b_2.UnsubscribeResponse unsubscribeResponse38 = null;
	                        org.oasis_open.docs.wsn.b_2.Unsubscribe wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               unsubscribeResponse38 =
                                                   
                                                   
                                                         skel.Unsubscribe(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), unsubscribeResponse38, false);
                                    } else 

            if("PauseSubscription".equals(methodName)){
                
                org.oasis_open.docs.wsn.b_2.PauseSubscriptionResponse pauseSubscriptionResponse40 = null;
	                        org.oasis_open.docs.wsn.b_2.PauseSubscription wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               pauseSubscriptionResponse40 =
                                                   
                                                   
                                                         skel.PauseSubscription(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), pauseSubscriptionResponse40, false);
                                    } else 

            if("Renew".equals(methodName)){
                
                org.oasis_open.docs.wsn.b_2.RenewResponse renewResponse42 = null;
	                        org.oasis_open.docs.wsn.b_2.Renew wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), renewResponse42, false);
                                    } else 
