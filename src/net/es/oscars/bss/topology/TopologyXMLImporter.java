...
public class TopologyXMLImporter {
    ...
    protected void importXML(Document doc, String operation) {
        ...
        while (domainIt.hasNext()) {
            ...
            Domain domDB = TopologyUtil.initDomain();
    ...
    protected void parseNodes(Element domXML, Domain domDB) {
        ...
        while (nodeXMLIterator.hasNext()) {
            ...
            Node nodeDB = TopologyUtil.initNode(domDB);
    ...
    protected void parsePorts(Element nodeXML, Node nodeDB) {
        ...
        while (portXMLIterator.hasNext()) {
            ...
            Port portDB = TopologyUtil.initPort(nodeDB);
            ...
            String strMaxRCapacity = portXML.getChild("maximumReservableCapacity",
                    ns).getValue();
            String strMinRCapacity = portXML.getChild("minimumReservableCapacity",
                    ns).getValue();
            String strGranularity = portXML.getChild("granularity", ns)
                                           .getValue();
    ...
    protected void parseLinkSwcap(Element linkXML, Link linkDB) {
        ...
        Element linkSwCapXML = linkXML.getChild("SwitchingCapabilityDescriptors",
                ns);
        ...
        Element swCapSpcXML = linkSwCapXML.getChild("switchingCapabilitySpecficInfo",
                ns);
        ...
        this.log.debug("l2cap: mtu: [" + new Integer(ifceMTU).toString() + "] vlanAv: [" +
            vlanAv + "]");
    ...
    protected void parseRemoteLink(Element linkXML, Link linkDB) {
        ...
        remoteLinkDB = TopologyUtil.initLink(remotePortDB);
