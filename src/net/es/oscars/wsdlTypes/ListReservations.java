   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
    ...
    public org.apache.axiom.om.OMDataSource getOMDataSource(
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName){
                ...
                //We can safely assume an element has only one type associated with it
                return localListReservations.getPullParser(MY_QNAME);
    ...
    public static class Factory{
        ...
        */
        public static ListReservations parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ListReservations object = new ListReservations();
            int event;
            try {
