   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
    ...
    public static class Factory{
        ...
        */
        public static PortID parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PortID object = new PortID();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"portID".equals(type)){
                        //find namespace for the prefix
                        java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                        return (PortID)net.es.oscars.wsdlTypes.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
