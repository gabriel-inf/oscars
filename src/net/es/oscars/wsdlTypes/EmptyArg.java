   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
    ...
    public static class Factory{
        ...
        */
        public static EmptyArg parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EmptyArg object = new EmptyArg();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"emptyArg".equals(type)){
                        //find namespace for the prefix
                        java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                        return (EmptyArg)net.es.oscars.wsdlTypes.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
