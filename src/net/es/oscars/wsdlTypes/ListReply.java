                        ...
                        */
                        ...
                        protected net.es.oscars.wsdlTypes.ResSummary[] localResInfo ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           protected boolean localResInfoTracker = false ;
                              ...
                              public void setResInfo(net.es.oscars.wsdlTypes.ResSummary[] param){
                                   ...
                                   validateResInfo(param);
                                          ...
                                          if (param != null){
                                             ...
                                             localResInfoTracker = true;
                                          } else {
                                             localResInfoTracker = false;
                                                 
                                          }
                                      
                                      this.localResInfo=param;
                              }
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
    ...
    public org.apache.axiom.om.OMDataSource getOMDataSource(
        ...
        org.apache.axiom.om.OMDataSource dataSource =
         ...
         public void serialize(
                ...
                if (localResInfoTracker){
                             if (localResInfo!=null){
                                    for (int i = 0;i < localResInfo.length;i++){
                                        if (localResInfo[i] != null){
                                         localResInfo[i].getOMDataSource(
                                                   new javax.xml.namespace.QName("http://oscars.es.net/OSCARS","resInfo"),
                                       ...
                                       throw new RuntimeException("resInfo cannot be null!!");
                                 ...
                                 for (int i = 0;i < localResInfo.length;i++){
                                    ...
                                    if (localResInfo[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://oscars.es.net/OSCARS",
                                                                          "resInfo"));
                                         elementList.add(localResInfo[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static ListReply parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ListReply object = new ListReply();
            int event;
            try {
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://oscars.es.net/OSCARS","resInfo").equals(reader.getName())){
