...
public class ConnectionServiceProvider extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/haniotak/ij12/0_6_trunk/nsi-soap/schema/r117/ConnectionService/ogf_nsi_connection_provider_v2_0.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ConnectionServiceProvider.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/haniotak/ij12/0_6_trunk/nsi-soap/schema/r117/ConnectionService/ogf_nsi_connection_provider_v2_0.wsdl");
        }
        WSDL_LOCATION = url;
    }
