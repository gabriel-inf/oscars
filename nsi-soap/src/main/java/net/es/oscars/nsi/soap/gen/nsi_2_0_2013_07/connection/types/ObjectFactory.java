...
package net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types;
 ...
 * generated in the net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types package. 
...
public class ObjectFactory {
    ...
    private final static QName _Provision_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "provision");
    private final static QName _QuerySummarySyncFailed_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "querySummarySyncFailed");
    private final static QName _ReserveTimeout_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "reserveTimeout");
    private final static QName _Terminate_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "terminate");
    private final static QName _QueryRecursive_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "queryRecursive");
    private final static QName _QueryNotificationSync_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "queryNotificationSync");
    private final static QName _QuerySummaryConfirmed_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "querySummaryConfirmed");
    private final static QName _ReserveCommitFailed_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "reserveCommitFailed");
    private final static QName _DataPlaneStateChange_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "dataPlaneStateChange");
    private final static QName _ErrorEvent_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "errorEvent");
    private final static QName _QuerySummary_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "querySummary");
    private final static QName _Release_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "release");
    private final static QName _ReserveAbortConfirmed_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "reserveAbortConfirmed");
    private final static QName _ServiceException_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "serviceException");
    private final static QName _QueryRecursiveConfirmed_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "queryRecursiveConfirmed");
    private final static QName _MessageDeliveryTimeout_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "messageDeliveryTimeout");
    private final static QName _ReserveCommit_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "reserveCommit");
    private final static QName _QueryNotificationConfirmed_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "queryNotificationConfirmed");
    private final static QName _ProvisionConfirmed_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "provisionConfirmed");
    private final static QName _QueryRecursiveFailed_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "queryRecursiveFailed");
    private final static QName _QueryNotificationFailed_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "queryNotificationFailed");
    private final static QName _TerminateConfirmed_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "terminateConfirmed");
    private final static QName _ReleaseConfirmed_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "releaseConfirmed");
    private final static QName _QuerySummaryFailed_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "querySummaryFailed");
    private final static QName _QuerySummarySync_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "querySummarySync");
    private final static QName _QueryNotificationSyncConfirmed_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "queryNotificationSyncConfirmed");
    private final static QName _QuerySummarySyncConfirmed_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "querySummarySyncConfirmed");
    private final static QName _ReserveConfirmed_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "reserveConfirmed");
    private final static QName _Reserve_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "reserve");
    private final static QName _ReserveResponse_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "reserveResponse");
    private final static QName _QueryNotificationSyncFailed_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "queryNotificationSyncFailed");
    private final static QName _ReserveCommitConfirmed_QNAME = new QName("http://schemas.ogf.org/nsi/2013/07/connection/types", "reserveCommitConfirmed");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "acknowledgment")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "reserveFailed")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "reserveAbort")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "provision")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "querySummarySyncFailed")
    public JAXBElement<QueryFailedType> createQuerySummarySyncFailed(QueryFailedType value) {
        return new JAXBElement<QueryFailedType>(_QuerySummarySyncFailed_QNAME, QueryFailedType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "reserveTimeout")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "terminate")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "queryRecursive")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "queryNotificationSync")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "querySummaryConfirmed")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "reserveCommitFailed")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "dataPlaneStateChange")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "errorEvent")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "querySummary")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "release")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "reserveAbortConfirmed")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "serviceException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "queryRecursiveConfirmed")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "messageDeliveryTimeout")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "reserveCommit")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "queryNotificationConfirmed")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "provisionConfirmed")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "queryRecursiveFailed")
    public JAXBElement<QueryFailedType> createQueryRecursiveFailed(QueryFailedType value) {
        return new JAXBElement<QueryFailedType>(_QueryRecursiveFailed_QNAME, QueryFailedType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "queryNotificationFailed")
    public JAXBElement<QueryFailedType> createQueryNotificationFailed(QueryFailedType value) {
        return new JAXBElement<QueryFailedType>(_QueryNotificationFailed_QNAME, QueryFailedType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "terminateConfirmed")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "releaseConfirmed")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "querySummaryFailed")
    public JAXBElement<QueryFailedType> createQuerySummaryFailed(QueryFailedType value) {
        return new JAXBElement<QueryFailedType>(_QuerySummaryFailed_QNAME, QueryFailedType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "querySummarySync")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "queryNotificationSyncConfirmed")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "querySummarySyncConfirmed")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "reserveConfirmed")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "reserve")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "reserveResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "queryNotificationSyncFailed")
    public JAXBElement<QueryFailedType> createQueryNotificationSyncFailed(QueryFailedType value) {
        return new JAXBElement<QueryFailedType>(_QueryNotificationSyncFailed_QNAME, QueryFailedType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", name = "reserveCommitConfirmed")
