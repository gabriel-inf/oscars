...
public interface ConnectionProviderPort {
     ...
     *             
     */
    @RequestWrapper(localName = "provision", targetNamespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", className = "net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types.GenericRequestType")
     ...
     *             
     */
    @RequestWrapper(localName = "reserveCommit", targetNamespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", className = "net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types.GenericRequestType")
     ...
     *             
     */
    @RequestWrapper(localName = "reserve", targetNamespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", className = "net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types.ReserveType")
    @WebMethod(action = "http://schemas.ogf.org/nsi/2013/07/connection/service/reserve")
    @ResponseWrapper(localName = "reserveResponse", targetNamespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", className = "net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types.ReserveResponseType")
    public void reserve(
        ...
        net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types.ReservationRequestCriteriaType criteria,
        @WebParam(name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/07/framework/headers", header = true)
        net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.framework.headers.CommonHeaderType header,
        @WebParam(mode = WebParam.Mode.OUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/07/framework/headers", header = true)
        javax.xml.ws.Holder<net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.framework.headers.CommonHeaderType> header1
    ...
    public net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types.GenericAcknowledgmentType queryRecursive(
        @WebParam(partName = "queryRecursive", name = "queryRecursive", targetNamespace = "http://schemas.ogf.org/nsi/2013/07/connection/types")
        net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types.QueryType queryRecursive,
     ...
     *             
     */
    @RequestWrapper(localName = "reserveAbort", targetNamespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", className = "net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types.GenericRequestType")
    ...
    public net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types.QueryNotificationConfirmedType queryNotificationSync(
        ...
        net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types.QueryNotificationType queryNotificationSync,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/07/framework/headers", header = true)
        javax.xml.ws.Holder<net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.framework.headers.CommonHeaderType> header
    ) throws net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.ifce.QueryNotificationSyncFailed;
     ...
     *             
     */
    @RequestWrapper(localName = "queryNotification", targetNamespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", className = "net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types.QueryNotificationType")
     ...
     *             
     */
    @RequestWrapper(localName = "release", targetNamespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", className = "net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types.GenericRequestType")
     ...
     *             
     */
    @RequestWrapper(localName = "terminate", targetNamespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", className = "net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types.GenericRequestType")
    ...
    public net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types.GenericAcknowledgmentType querySummary(
        @WebParam(partName = "querySummary", name = "querySummary", targetNamespace = "http://schemas.ogf.org/nsi/2013/07/connection/types")
        net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types.QueryType querySummary,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/07/framework/headers", header = true)
        javax.xml.ws.Holder<net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.framework.headers.CommonHeaderType> header
    ) throws net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.ifce.ServiceException;
    ...
    public net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types.QuerySummaryConfirmedType querySummarySync(
        ...
        net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.types.QueryType querySummarySync,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/07/framework/headers", header = true)
        javax.xml.ws.Holder<net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.framework.headers.CommonHeaderType> header
    ) throws net.es.oscars.nsi.soap.gen.nsi_2_0_2013_07.connection.ifce.QuerySummarySyncFailed;
}
