...
package net.es.oscars.nsi.soap.gen.xmlenc;
...
import net.es.oscars.nsi.soap.gen.xmldsig.KeyInfoType;


/**
 * This object contains factory methods for each 
 * Java content interface and Java element interface 
 * generated in the net.es.oscars.nsi.soap.gen.xmlenc package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.es.oscars.nsi.soap.gen.xmlenc
     * 
     */
