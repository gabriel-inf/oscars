...
public interface ConnectionProviderPort {
    ...
    public net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.GenericAcknowledgmentType querySummary(
        @WebParam(partName = "querySummary", name = "querySummary", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types")
        net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.QueryType querySummary,
     ...
     *             
     */
    @RequestWrapper(localName = "provision", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.GenericRequestType")
     ...
     *             
     */
    @RequestWrapper(localName = "terminate", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.GenericRequestType")
     ...
     *             
     */
    @RequestWrapper(localName = "release", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.GenericRequestType")
     ...
     *             
     */
    @RequestWrapper(localName = "reserveAbort", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.GenericRequestType")
    ...
    @RequestWrapper(localName = "queryResultSync", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.QueryResultType")
    @WebMethod(action = "http://schemas.ogf.org/nsi/2013/12/connection/service/queryResultSync")
    @ResponseWrapper(localName = "queryResultSyncConfirmed", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.QueryResultConfirmedType")
    public java.util.List<net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.QueryResultResponseType> queryResultSync(
        @WebParam(name = "connectionId", targetNamespace = "")
        java.lang.String connectionId,
        ...
        @WebParam(mode = WebParam.Mode.OUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<net.es.oscars.nsi.soap.gen.nsi_2_0_r117.framework.headers.CommonHeaderType> header1
    ) throws net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.ifce.Error;
     ...
     *             
     */
    @RequestWrapper(localName = "reserveCommit", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.GenericRequestType")
    ...
    public net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.GenericAcknowledgmentType queryRecursive(
        @WebParam(partName = "queryRecursive", name = "queryRecursive", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types")
        net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.QueryType queryRecursive,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<net.es.oscars.nsi.soap.gen.nsi_2_0_r117.framework.headers.CommonHeaderType> header
    ) throws net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.ifce.ServiceException;
     ...
     *             
     */
    @RequestWrapper(localName = "reserve", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.ReserveType")
    @WebMethod(action = "http://schemas.ogf.org/nsi/2013/12/connection/service/reserve")
    @ResponseWrapper(localName = "reserveResponse", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.ReserveResponseType")
    public void reserve(
        ...
        net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.ReservationRequestCriteriaType criteria,
        @WebParam(name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        net.es.oscars.nsi.soap.gen.nsi_2_0_r117.framework.headers.CommonHeaderType header,
        @WebParam(mode = WebParam.Mode.OUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<net.es.oscars.nsi.soap.gen.nsi_2_0_r117.framework.headers.CommonHeaderType> header1
    ...
    public net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.QueryNotificationConfirmedType queryNotificationSync(
        ...
        net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.QueryNotificationType queryNotificationSync,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<net.es.oscars.nsi.soap.gen.nsi_2_0_r117.framework.headers.CommonHeaderType> header
    ) throws net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.ifce.Error;
     ...
     *             
     */
    @RequestWrapper(localName = "queryNotification", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.QueryNotificationType")
    ...
    public net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.QuerySummaryConfirmedType querySummarySync(
        ...
        net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.QueryType querySummarySync,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<net.es.oscars.nsi.soap.gen.nsi_2_0_r117.framework.headers.CommonHeaderType> header
    ) throws net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.ifce.Error;
     ...
     *             
     */
    @RequestWrapper(localName = "queryResult", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.oscars.nsi.soap.gen.nsi_2_0_r117.connection.types.QueryResultType")
