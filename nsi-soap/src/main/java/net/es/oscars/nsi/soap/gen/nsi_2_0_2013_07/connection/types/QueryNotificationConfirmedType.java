 ...
 *           &lt;element ref="{http://schemas.ogf.org/nsi/2013/07/connection/types}errorEvent"/>
 *           &lt;element ref="{http://schemas.ogf.org/nsi/2013/07/connection/types}reserveTimeout"/>
 *           &lt;element ref="{http://schemas.ogf.org/nsi/2013/07/connection/types}dataPlaneStateChange"/>
 *           &lt;element ref="{http://schemas.ogf.org/nsi/2013/07/connection/types}messageDeliveryTimeout"/>
 *         &lt;/choice>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
...
public class QueryNotificationConfirmedType {
    ...
    @XmlElements({
        @XmlElement(name = "errorEvent", namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", type = ErrorEventType.class),
        @XmlElement(name = "reserveTimeout", namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", type = ReserveTimeoutRequestType.class),
        @XmlElement(name = "dataPlaneStateChange", namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", type = DataPlaneStateChangeRequestType.class),
        @XmlElement(name = "messageDeliveryTimeout", namespace = "http://schemas.ogf.org/nsi/2013/07/connection/types", type = MessageDeliveryTimeoutRequestType.class)
    })
